...
pub fn IntroMessage() -> impl IntoView {
    view! {
        <div class="text-base px-28">
            ...
            <p class="pb-4">
                <span class="font-bold text-xl">"ODP Projects"</span>
            </p>
            <ul class="pb-4 text-lg list-disc">
                <li class="list-inside">
                    <b class="text-blue-800">"Fast and Minimal Boot Firmware"</b>
                    " - A secure and efficient boot firmware for Windows devices"
                </li>
                <li class="list-inside">
                    <b class="text-blue-800">"Hardened Embedded Controller Firmware"</b>
                    " - An extensible, MCU-agnostic, secure embedded controller firmware"
                </li>
                <li class="list-inside">
                    <b class="text-blue-800">"Standardized Embedded Controller Services"</b>
            ...
            <p class="pb-4 text-lg">
                ...
                <a href="mailto:odpadmin@microsoft.com" class="underline text-blue-500">
                    "ODP Administrators"
                </a>"
            ...
            <p class="pb-4">
                <span class="font-bold text-xl">"Value Proposition"</span>
            </p>
            <ul class="pb-4 text-lg">
                <li class="list-disc list-inside -indent-14 pl-14">
                    <b class="text-blue-800">"Enhanced Security"</b>
                ...
                <li class="list-disc list-inside -indent-14 pl-14">
                    <b class="text-blue-800">"Standardization"</b>
                ...
                <li class="list-disc list-inside -indent-14 pl-14">
                    <b class="text-blue-800">"Accelerated Development"</b>
            ...
            <p class="pb-4">
                <span class="font-bold text-xl">"Partner-Oriented Vision"</span>
            </p>
            <p class="pb-4 text-lg">
            ...
            <p class="pb-4">
                <span class="font-bold text-xl">"Get Involved"</span>
            </p>
            <p class="pb-4 text-lg">
