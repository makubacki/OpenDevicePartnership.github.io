...
pub fn IntroMessage() -> impl IntoView {
    view! {
        <div class="text-base px-28">
            ...
            <p class="pb-4 text-lg">ODP is an open initiative aimed at making it easier to build secure Windows devices with solid 
            ...
            to set new standards for security, performance, battery life, and reliability while maximizing code re-use.</p>

            <p class="pb-4"><span class="font-bold text-xl whitespace-normal">ODP Projects</span></p>
            <ul class="pb-4 text-lg list-disc">
                <li class="list-inside"><i>Fast and Minimal Boot Firmware</i> - A secure and efficient boot firmware for Windows devices</li>
                <li class="list-inside"><i>Hardened Embedded Controller Firmware</i> - An extensible, MCU-agnostic, secure embedded controller firmware</li>
                <li class="list-inside"><i>Standardized Embedded Controller Services</i> - A common method for interfacing embedded controller services with Windows</li>
            </ul>
            <p class="pb-4"><span class="text-lg">While we have ambitious goals for these first projects, we are also interested in 
            adding new projects to the partnership that align with our shared goals.  More information about partnership governance 
            and how to start new projects will be provided shortly.  In the meantime, please reach out to <a href="mailto:odpadmin@microsoft.com" style="text-decoration:underline;">ODP Administrators</a>  
            with questions or comments.</span></p>

            <p class="pb-4"><span class="font-bold text-xl whitespace-normal">Value Proposition</span></p>
            <ul class="pb-4 text-lg">
                <li class="list-disc list-inside"><i>Enhanced Security</i> - As security threats continue to evolve, it is critical we take 
                ...
                <li class="list-disc list-inside"><i>Standardization</i> - While it is critical for device partners to differentiate in features and 
                ...
                <li class="list-disc list-inside"><i>Accelerated Development</i> - ODP is built on open-source collaboration with partners, 
