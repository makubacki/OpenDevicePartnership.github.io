...
![Host FW Evolution](./uefi_images/uefi_evolution.png)

### Safety Without Garbage Collection Overhead

![Security](uefi_images/security_icon.png)
...
![Performance](./uefi_images/perf_icon.png)
...
![Memory Safety](./uefi_images/bug_icon.png)
...
![Productivity](./uefi_images/terminal_icon.svg)
...
![Tooling](./uefi_images/tooling_icon.svg)
...
![ODP Community](./uefi_images/community_icon.svg)
...
![DXE Architecture](./uefi_images/dxe_arch_1.png)
...
| ![UEFI Boot Services Call Count 1](./uefi_images/bootserv_call_table_1.png) | ![UEFI Boot Services Call Count 2](./uefi_images/bootserv_call_table_2.png)  |
|---|---|
...
information is available. This section is meant to provide a high-level overview of the process.
